...
#python train.py --n_steps=500000 --save_every=100000 --n_speakers=$BATCH_SIZE --n_valids=16 --n_utterances=$N_UTTER --checkpoint_path=$CHECKPOINT_PATH $DATA_DIR $MODEL_DIR dvector_config.yaml
